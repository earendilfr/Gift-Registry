...
CREATE TABLE `items` (
  ...
  CONSTRAINTE fk_users
    FOREIGN KEY (userid) REFERENCES users(userid)
    ON DELETE CASCADE,
  CONSTRAINTE fk_categories
    FOREIGN KEY (category) REFERENCES categories(categoryid)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINTE fk_ranking
    FOREIGN KEY (ranking) REFERENCES ranks(ranking)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
) ENGINE=InnoDB;
...
CREATE TABLE `messages` (
  ...
  CONSTRAINTE fk_users_sender
    FOREIGN KEY (sender) REFERENCES users(userid)
    ON DELETE CASCADE,
  CONSTRAINTE fk_users_recipient
...
CREATE TABLE `shoppers` (
  ...
  CONSTRAINTE fk_users_shopper
    FOREIGN KEY (shopper) REFERENCES users(userid)
    ON DELETE CASCADE,
  CONSTRAINTE fk_users_mayshopfor
    FOREIGN KEY (mayshopfor) REFERENCES users(userid)
    ON DELETE CASCADE,
) ENGINE=InnoDB;
...
CREATE TABLE `subscriptions` (
  ...
  CONSTRAINTE fk_users_publisher
    FOREIGN KEY (publisher) REFERENCES users(userid)
    ON DELETE CASCADE,
  CONSTRAINTE fk_users_subscriber
